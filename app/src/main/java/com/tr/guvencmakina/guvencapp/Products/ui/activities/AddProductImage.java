...
public class AddProductImage extends AppCompatActivity implements IImagePickerLister {
...
//
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AddProductDetailsActivity.class);
...
public void saveProduct(String image_url){
    if(AddProductDetailsActivity.product != null){
        mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("products").child(AddProductDetailsActivity.product.getName());
        HashMap<String,String> userMap = new HashMap<>();
        userMap.put("name", AddProductDetailsActivity.product.getName());
        userMap.put("category", AddProductDetailsActivity.product.getCategory());
        userMap.put("price", AddProductDetailsActivity.product.getPrice());
        userMap.put("material", AddProductDetailsActivity.product.getMaterial());
        userMap.put("safety", AddProductDetailsActivity.product.getSafety());
        ...
        mDatabaseReference.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toasty.success(getApplicationContext(),getString(R.string.adding_product_success), Toast.LENGTH_SHORT).show();
                    hideLoader();
                    ...
                    System.out.println("adding product failed " + task.getException().getMessage());
                    Toasty.error(getApplicationContext(),getString(R.string.adding_product_failure),Toast.LENGTH_SHORT).show();
                    hideLoader();
                }
            }
        });
    ...
    public void uploadImageFile(Uri fileUri){
        showLoader();
        StorageReference riversRef = storageReference.child("product_images/" + AddProductDetailsActivity.product.getName() + ".jpg");
